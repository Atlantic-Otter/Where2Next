...
// todo: add a User.remove(//some function to delete users added from the test, perhaps add a `created_at: Date.now()` to schema - at end of test call .remove on any documents matching Date.now() - 3000);
